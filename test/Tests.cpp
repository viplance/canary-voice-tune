...
int main(int argc, char* argv[]) {
    ...
    std::cout << "\nTest 4: Verifying standard VST presets and keyboard note mapping" << std::endl;
    {
        ...
        // Let's verify a few notes:
        // A0 (MIDI 21) -> pitchClass 9 -> enabled (true)
        // A#0 (MIDI 22) -> pitchClass 10 -> disabled (false)
        // B0 (MIDI 23) -> pitchClass 11 -> enabled (true)
        // C1 (MIDI 24) -> pitchClass 0 -> enabled (true)
        // C#1 (MIDI 25) -> pitchClass 1 -> disabled (false)
        // D1 (MIDI 26) -> pitchClass 2 -> enabled (true)
        ...
        // A Minor (presetIdx = 20): rootIdx = (19 / 2) % 12 = 9 (A), isMinor = true
        // Notes: A, B, C, D, E, F, G (pitchClasses: 9, 11, 0, 2, 4, 5, 7)
        // Let's verify:
        // A0 (MIDI 21) -> pitchClass 9 -> enabled (true)
        // A#0 (MIDI 22) -> pitchClass 10 -> disabled (false)
        // B0 (MIDI 23) -> pitchClass 11 -> enabled (true)
